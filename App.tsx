...
import Page_0 from "./pages/games.$gameId.tsx";
import PageLayout_0 from "./pages/games.$gameId.pageLayout.tsx";
...
const fileNameToRoute = new Map([["./pages/games.$gameId.tsx","/games/:gameId"],["./pages/_index.tsx","/"],["./pages/dashboard.tsx","/dashboard"]]);
const fileNameToComponent = new Map([
    ["./pages/games.$gameId.tsx", Page_0],
...
"./pages/games.$gameId.tsx": PageLayout_0,
